                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-1">
                                {[0, 1, 2, 3, 4].map((index) => (
                                    <div
                                        key={index}
                                        className={`h-1.5 flex-1 rounded-full transition-all ${index <= strengthScore - 1 ? getStrengthColor(strengthScore) : 'bg-gray-200'
                                            }`}
                                    />
                                ))}
                            </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`w-full px-4 py-3 pr-12 bg-card border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all ${passwordsMismatch
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-amber-700 leading-relaxed">
                                There is no password reset feature. If you forget your password,
                                you'll need your recovery phrase to access your wallet.
                            </p>
                        </div>
                    </div>
                </form>
