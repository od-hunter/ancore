            ...
            <div className="flex-1 px-6 overflow-y-auto">
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-amber-700 leading-relaxed">
                                    Anyone with these words can steal your funds. Ancore will NEVER
                                    ask for your recovery phrase. Store it offline in a safe place.
                                </p>
                            </div>
                            <button
                ...
                <label className="flex items-start gap-3 p-4 bg-primary/5 border border-primary/20 rounded-xl cursor-pointer mb-6">
                    ...
                    <span className="text-xs text-foreground leading-relaxed">
                        I understand that if I lose my recovery phrase, I will lose access
                        to my wallet and all funds permanently.
                    </span>
                </label>
            </div>
