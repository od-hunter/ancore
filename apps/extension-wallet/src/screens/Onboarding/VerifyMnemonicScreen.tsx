            ...
            <div className="flex-1 px-6 overflow-y-auto">
                ...
                <div className="text-center mb-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Enter the following words from your recovery phrase to confirm you've saved them correctly.
                    </p>
                </div>
                        ...
                        <div key={inputIndex} className="space-y-2">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full px-4 py-3 bg-card border rounded-xl text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all ${input.isCorrect === true
                    ...
                    <div className="bg-card rounded-xl border border-border/50 p-4 mb-6">
                        <div className="grid grid-cols-3 gap-2">
                            {words.map((word, index) => (
                                <div
                                    key={index}
                                    className={`flex items-center gap-2 rounded-lg px-3 py-2 ${verificationIndices.includes(index)
                ...
                <div className="bg-muted/30 rounded-xl p-4 mb-6">
                    <p className="text-xs text-muted-foreground leading-relaxed">
                        <strong className="text-foreground">Tip:</strong> If you didn't save your
                        recovery phrase, go back and write it down before continuing. Without it,
                        you won't be able to recover your wallet.
                    </p>
                </div>
            </div>
