                ...
                {isDeploying && (
                    <div className="space-y-4 max-w-sm mx-auto">
                        {DEPLOYMENT_STEPS.map((step, index) => {
                            ...
                            const isCurrent = !isComplete && !completedSteps.includes(
                                DEPLOYMENT_STEPS[index - 1]?.id
                            );

                            return (
                                <div
                                    key={step.id}
                                    className={`flex items-center gap-3 p-3 rounded-xl transition-all ${isComplete
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        <p className={`text-sm font-medium ${isComplete
                                            ? 'text-green-700'
                                            : isCurrent
                                                ? 'text-foreground'
